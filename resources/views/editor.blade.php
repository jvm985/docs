                ...
                @if($project->user_id === auth()->id())
                    <div class="flex gap-1">
                        ...
                        <button @click="createItem('folder')" title="Nieuwe map" class="rounded p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-700">
                            ...
                            <button title="Uploaden" onclick="document.getElementById('upload-input').click()" class="rounded p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-700">
                        ...
                        <input type="file" id="upload-input" class="hidden" multiple onchange="window._handleUpload(this)">
                    </div>
                @endif
            </div>

            ...
            <div class="flex items-center justify-between border-b px-3 py-2">
                ...
                @if($project->user_id === auth()->id())
                    <div class="flex gap-1">
                        ...
                        <label for="upload-files" title="Bestanden uploaden" class="cursor-pointer rounded p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-700">
                        ...
                        <input type="file" id="upload-files" class="hidden" multiple onchange="window._handleUpload(this)">
                        <label for="upload-folder" title="Map uploaden" class="cursor-pointer rounded p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-700">
                        ...
                        <input type="file" id="upload-folder" class="hidden" webkitdirectory onchange="window._handleUpload(this)">
                    </div>
                @endif
            </div>

...
#let answer(height) = block(
  width: 100%,
  stroke: (bottom: 0.5pt + gray.lighten(50%)),
  inset: (bottom: 2pt),
  height: height,
  [
    #set text(fill: gray.lighten(50%))
    #repeat[#line(length: 100%, stroke: (dash: "dotted")) #v(1.5em)]
  ]
)
...
';
$file->save();
echo "Updated template.typ with full environment support\n";
